					...
					<div class="product">
						...
						<div class="col-md-6">
							<div class="caption">
								...
								<div class="info">
									<ul>
										<li>Loại sản phẩm: <a href="/category.php?manhasx=<?php echo $row["Manhasx"]?>"><?php echo $row["Tennhasx"]?></a> <h3></li>
									</ul>
								</div>
								<?php
      ...
      <div class="modal-content">
		...
		<input type="text" class="form-control" placeholder="Tên:" name="name" id="name" required>
						...
						<label> Hình thức thanh toán :<select class="selectpicker" name="hinhthuctt">
    										<option value="ATM">Thẻ tín dụng</option>
    										<option value="Live">Ship COD</option>
  											</optgroup>
										</select>
										</lable>
						</div>
