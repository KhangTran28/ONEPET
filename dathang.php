  ...
  <form name="form6" id="ff6" method="POST" action="<?php include 'luudonhang.php'?>">
	<div id="page-content" class="single-page">
		...
		<div class="container">
			...
			<label for="toggle_slidebar">
			<input type="radio" id="radio1" name="group-radio" /><img src="images/visa-curved-32px.png">
			<input type="radio" id="radio1" name="group-radio" /><img src="images/mastercard.png"><br>
			<input type="radio" id="radio1" name="group-radio" /><label> Thanh toán khi nhận được hàng
			</label>
	   		...
	   		<style>
				...
				#toggle_slidebar:checked ~.radio1{
					display: block;
				}
			</style>
			 </div>
			...
			<label>Voucher</label>
                    <select class="form-control select2" multiple="multiple" name="voucher" id="voucher" onchange ="laygiatheoiddichvu(this.value)"  data-placeholder="Chọn voucher" >
										<?php
				...
				<div class="product well">
					...
					<div class="col-md-9">
						<div class="caption">
							...
							<div class="info">	
								<ul>
									<li>Loại sản phẩm: <?php  echo $s["Tennhasx"]?></li>
								</ul>
							</div>
							<?php
							if($s["KhuyenMai"] == true)
